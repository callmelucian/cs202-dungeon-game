...
* **Developer B (Specials Decorators, Echo Subject/Observer & Items)**
  ...
  - [x] Implement `Item` abstract base class with `position`, `bounds`, `onCollect(Player&, Chamber&)` (per architecture.puml Economy package).
  ...
  - [x] *Seminar:* Detailed content for `Facade` pattern (11 items) + LaTeX report.
